...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#edeff1"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="签到时段" prop="qiandaoshiduan">
            <el-input v-model="ruleForm.qiandaoshiduan" 
                placeholder="签到时段" clearable :disabled=" false  ||ro.qiandaoshiduan"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="签到流程" prop="qiandaoliucheng">
            <el-input v-model="ruleForm.qiandaoliucheng" 
                placeholder="签到流程" clearable :disabled=" false  ||ro.qiandaoliucheng"></el-input>
          </el-form-item>
